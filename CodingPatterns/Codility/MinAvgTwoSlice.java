...
public class MinAvgTwoSlice {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The min average two slice is: " + minAvgSlice(A));
    }
    
    private static int minAvgSlice(int[] A) {

        // main idea: we know from the problem description that the slices have a minimum length of 2.
